...
def get_ip_info(source_ip="0.0.0.0", source_port=10035, stun_host=None, stun_port=3478):
...
s.bind((source_ip, source_port))
for i in range(100):
    s.sendto(binascii.a2b_hex('00010000EB2BE64F5CAA50504F44BF7107C35F19'), (stun_host, stun_port))
